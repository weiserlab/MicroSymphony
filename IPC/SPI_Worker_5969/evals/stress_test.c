...
int main(void){
    ...
    //P4.2 as input for experiment trigger
    P4DIR &= ~BIT2;
    P4REN |= BIT2;
    P4OUT |= BIT2;
...
// }
        ...
        // if (read_data != 0xDE) {
        //     uart0_println("FRAM read/write test failed");
        // }
        // else {
        //     uart0_println("FRAM read/write test passed");
        // }
        ...
        // for (delay_cnt = 800000u; delay_cnt > 0u; delay_cnt--) {
        //     __no_operation();
        // }
